...
"MINDSPACE": "MINDSPACE BUSINESS PARKS REIT UNT",
...
"QPOWER-BE": "QUALITY POWER ELECTRICAL EQUIPMENTS LIMITED",
...
"STLTECH-BE": "STERLITE TECHNOLOGIES LIMITED",
...
def color_column(col):
    ...
    Each column is scaled independently from red to orange to yellow to green.
    The lowest value in that column is red; the highest is green.
    """
    styles = []
    valid = col.dropna()
    if valid.empty:
    ...
    for val in col:
        ...
        # Map rank to red-orange-yellow-green colour scale
        if rank >= 0.85:
            bg, fg = "#63be7b", "#0f1117"
        elif rank >= 0.70:
            bg, fg = "#a8d66d", "#0f1117"
...
<div style='display:flex; gap:1rem; margin-top:0.5rem; flex-wrap:wrap; align-items:center;'>
  <span style='font-size:0.72rem; font-family:monospace; color:#6b7280;'>Color scale (per-column rank):</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#f8696b; color:#0f1117; padding:1px 8px; border-radius:3px;'>Lowest</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#f89a6b; color:#0f1117; padding:1px 8px; border-radius:3px;'>Low</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#fdbf6f; color:#0f1117; padding:1px 8px; border-radius:3px;'>Below mid</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#ffeb84; color:#0f1117; padding:1px 8px; border-radius:3px;'>Mid</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#d9e67a; color:#0f1117; padding:1px 8px; border-radius:3px;'>Above mid</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#a8d66d; color:#0f1117; padding:1px 8px; border-radius:3px;'>High</span>
  <span style='font-size:0.72rem; font-family:monospace; background:#63be7b; color:#0f1117; padding:1px 8px; border-radius:3px;'>Highest</span>
